...
#define REG_IO_U64(offset) (*(volatile u64 *)(gIoRegisters + (offset)))
#else
#define REG_IO_U8(offset)  (*(volatile u8  *)(REG_BASE + (offset)))
#define REG_IO_U16(offset) (*(volatile u16 *)(REG_BASE + (offset)))
#define REG_IO_U32(offset) (*(volatile u32 *)(REG_BASE + (offset)))
#define REG_IO_U64(offset) (*(volatile u64 *)(REG_BASE + (offset)))
#endif

#define READ_REG_U8(offset)      REG_IO_U8(offset)
#define WRITE_REG_U8(offset, v)  (REG_IO_U8(offset) = (v))
#define READ_REG_U16(offset)     REG_IO_U16(offset)
#define WRITE_REG_U16(offset, v) (REG_IO_U16(offset) = (v))
#define READ_REG_U32(offset)     REG_IO_U32(offset)
#define WRITE_REG_U32(offset, v) (REG_IO_U32(offset) = (v))
#define READ_REG_U64(offset)     REG_IO_U64(offset)
#define WRITE_REG_U64(offset, v) (REG_IO_U64(offset) = (v))

// I/O registers

#define REG_DISPCNT     REG_IO_U16(REG_OFFSET_DISPCNT)
#define REG_DISPSTAT    REG_IO_U16(REG_OFFSET_DISPSTAT)
#define REG_VCOUNT      REG_IO_U16(REG_OFFSET_VCOUNT)
#define REG_BG0CNT      REG_IO_U16(REG_OFFSET_BG0CNT)
#define REG_BG1CNT      REG_IO_U16(REG_OFFSET_BG1CNT)
#define REG_BG2CNT      REG_IO_U16(REG_OFFSET_BG2CNT)
#define REG_BG3CNT      REG_IO_U16(REG_OFFSET_BG3CNT)
#define REG_BG0HOFS     REG_IO_U16(REG_OFFSET_BG0HOFS)
#define REG_BG0VOFS     REG_IO_U16(REG_OFFSET_BG0VOFS)
#define REG_BG1HOFS     REG_IO_U16(REG_OFFSET_BG1HOFS)
#define REG_BG1VOFS     REG_IO_U16(REG_OFFSET_BG1VOFS)
#define REG_BG2HOFS     REG_IO_U16(REG_OFFSET_BG2HOFS)
#define REG_BG2VOFS     REG_IO_U16(REG_OFFSET_BG2VOFS)
#define REG_BG3HOFS     REG_IO_U16(REG_OFFSET_BG3HOFS)
#define REG_BG3VOFS     REG_IO_U16(REG_OFFSET_BG3VOFS)
#define REG_BG2PA       REG_IO_U16(REG_OFFSET_BG2PA)
#define REG_BG2PB       REG_IO_U16(REG_OFFSET_BG2PB)
#define REG_BG2PC       REG_IO_U16(REG_OFFSET_BG2PC)
#define REG_BG2PD       REG_IO_U16(REG_OFFSET_BG2PD)
#define REG_BG2X        REG_IO_U32(REG_OFFSET_BG2X)
#define REG_BG2X_L      REG_IO_U16(REG_OFFSET_BG2X_L)
#define REG_BG2X_H      REG_IO_U16(REG_OFFSET_BG2X_H)
#define REG_BG2Y        REG_IO_U32(REG_OFFSET_BG2Y)
#define REG_BG2Y_L      REG_IO_U16(REG_OFFSET_BG2Y_L)
#define REG_BG2Y_H      REG_IO_U16(REG_OFFSET_BG2Y_H)
#define REG_BG3PA       REG_IO_U16(REG_OFFSET_BG3PA)
#define REG_BG3PB       REG_IO_U16(REG_OFFSET_BG3PB)
#define REG_BG3PC       REG_IO_U16(REG_OFFSET_BG3PC)
#define REG_BG3PD       REG_IO_U16(REG_OFFSET_BG3PD)
#define REG_BG3X        REG_IO_U32(REG_OFFSET_BG3X)
#define REG_BG3X_L      REG_IO_U16(REG_OFFSET_BG3X_L)
#define REG_BG3X_H      REG_IO_U16(REG_OFFSET_BG3X_H)
#define REG_BG3Y        REG_IO_U32(REG_OFFSET_BG3Y)
#define REG_BG3Y_L      REG_IO_U16(REG_OFFSET_BG3Y_L)
#define REG_BG3Y_H      REG_IO_U16(REG_OFFSET_BG3Y_H)
#define REG_WIN0H       REG_IO_U16(REG_OFFSET_WIN0H)
#define REG_WIN1H       REG_IO_U16(REG_OFFSET_WIN1H)
#define REG_WIN0V       REG_IO_U16(REG_OFFSET_WIN0V)
#define REG_WIN1V       REG_IO_U16(REG_OFFSET_WIN1V)
#define REG_WININ       REG_IO_U16(REG_OFFSET_WININ)
#define REG_WINOUT      REG_IO_U16(REG_OFFSET_WINOUT)
#define REG_MOSAIC      REG_IO_U16(REG_OFFSET_MOSAIC)
#define REG_BLDCNT      REG_IO_U16(REG_OFFSET_BLDCNT)
#define REG_BLDALPHA    REG_IO_U16(REG_OFFSET_BLDALPHA)
#define REG_BLDY        REG_IO_U16(REG_OFFSET_BLDY)

#define REG_SOUND1CNT_L REG_IO_U16(REG_OFFSET_SOUND1CNT_L)
#define REG_NR10        REG_IO_U8(REG_OFFSET_NR10)
#define REG_SOUND1CNT_H REG_IO_U16(REG_OFFSET_SOUND1CNT_H)
#define REG_NR11        REG_IO_U8(REG_OFFSET_NR11)
#define REG_NR12        REG_IO_U8(REG_OFFSET_NR12)
#define REG_SOUND1CNT_X REG_IO_U16(REG_OFFSET_SOUND1CNT_X)
#define REG_NR13        REG_IO_U8(REG_OFFSET_NR13)
#define REG_NR14        REG_IO_U8(REG_OFFSET_NR14)
#define REG_SOUND2CNT_L REG_IO_U16(REG_OFFSET_SOUND2CNT_L)
#define REG_NR21        REG_IO_U8(REG_OFFSET_NR21)
#define REG_NR22        REG_IO_U8(REG_OFFSET_NR22)
#define REG_SOUND2CNT_H REG_IO_U16(REG_OFFSET_SOUND2CNT_H)
#define REG_NR23        REG_IO_U8(REG_OFFSET_NR23)
#define REG_NR24        REG_IO_U8(REG_OFFSET_NR24)
#define REG_SOUND3CNT_L REG_IO_U16(REG_OFFSET_SOUND3CNT_L)
#define REG_NR30        REG_IO_U8(REG_OFFSET_NR30)
#define REG_SOUND3CNT_H REG_IO_U16(REG_OFFSET_SOUND3CNT_H)
#define REG_NR31        REG_IO_U8(REG_OFFSET_NR31)
#define REG_NR32        REG_IO_U8(REG_OFFSET_NR32)
#define REG_SOUND3CNT_X REG_IO_U16(REG_OFFSET_SOUND3CNT_X)
#define REG_NR33        REG_IO_U8(REG_OFFSET_NR33)
#define REG_NR34        REG_IO_U8(REG_OFFSET_NR34)
#define REG_SOUND4CNT_L REG_IO_U16(REG_OFFSET_SOUND4CNT_L)
#define REG_NR41        REG_IO_U8(REG_OFFSET_NR41)
#define REG_NR42        REG_IO_U8(REG_OFFSET_NR42)
#define REG_SOUND4CNT_H REG_IO_U16(REG_OFFSET_SOUND4CNT_H)
#define REG_NR43        REG_IO_U8(REG_OFFSET_NR43)
#define REG_NR44        REG_IO_U8(REG_OFFSET_NR44)
#define REG_SOUNDCNT_L  REG_IO_U16(REG_OFFSET_SOUNDCNT_L)
#define REG_NR50        REG_IO_U8(REG_OFFSET_NR50)
#define REG_NR51        REG_IO_U8(REG_OFFSET_NR51)
#define REG_SOUNDCNT_H  REG_IO_U16(REG_OFFSET_SOUNDCNT_H)
#define REG_SOUNDCNT_X  REG_IO_U16(REG_OFFSET_SOUNDCNT_X)
#define REG_NR52        REG_IO_U8(REG_OFFSET_NR52)
#define REG_SOUNDBIAS   REG_IO_U16(REG_OFFSET_SOUNDBIAS)
#define REG_SOUNDBIAS_L REG_IO_U8(REG_OFFSET_SOUNDBIAS_L)
#define REG_SOUNDBIAS_H REG_IO_U8(REG_OFFSET_SOUNDBIAS_H)
#define REG_WAVE_RAM0   REG_IO_U32(REG_OFFSET_WAVE_RAM0)
#define REG_WAVE_RAM1   REG_IO_U32(REG_OFFSET_WAVE_RAM1)
#define REG_WAVE_RAM2   REG_IO_U32(REG_OFFSET_WAVE_RAM2)
#define REG_WAVE_RAM3   REG_IO_U32(REG_OFFSET_WAVE_RAM3)
#define REG_FIFO_A      REG_IO_U32(REG_OFFSET_FIFO_A)
#define REG_FIFO_B      REG_IO_U32(REG_OFFSET_FIFO_B)

#define REG_DMA0SAD     REG_IO_U32(REG_OFFSET_DMA0SAD)
#define REG_DMA0DAD     REG_IO_U32(REG_OFFSET_DMA0DAD)
#define REG_DMA0CNT     REG_IO_U32(REG_OFFSET_DMA0CNT)
#define REG_DMA0CNT_L   REG_IO_U16(REG_OFFSET_DMA0CNT_L)
#define REG_DMA0CNT_H   REG_IO_U16(REG_OFFSET_DMA0CNT_H)

#define REG_DMA1SAD     REG_IO_U32(REG_OFFSET_DMA1SAD)
#define REG_DMA1DAD     REG_IO_U32(REG_OFFSET_DMA1DAD)
#define REG_DMA1CNT     REG_IO_U32(REG_OFFSET_DMA1CNT)
#define REG_DMA1CNT_L   REG_IO_U16(REG_OFFSET_DMA1CNT_L)
#define REG_DMA1CNT_H   REG_IO_U16(REG_OFFSET_DMA1CNT_H)

#define REG_DMA2SAD     REG_IO_U32(REG_OFFSET_DMA2SAD)
#define REG_DMA2DAD     REG_IO_U32(REG_OFFSET_DMA2DAD)
#define REG_DMA2CNT     REG_IO_U32(REG_OFFSET_DMA2CNT)
#define REG_DMA2CNT_L   REG_IO_U16(REG_OFFSET_DMA2CNT_L)
#define REG_DMA2CNT_H   REG_IO_U16(REG_OFFSET_DMA2CNT_H)

#define REG_DMA3SAD     REG_IO_U32(REG_OFFSET_DMA3SAD)
#define REG_DMA3DAD     REG_IO_U32(REG_OFFSET_DMA3DAD)
#define REG_DMA3CNT     REG_IO_U32(REG_OFFSET_DMA3CNT)
#define REG_DMA3CNT_L   REG_IO_U16(REG_OFFSET_DMA3CNT_L)
#define REG_DMA3CNT_H   REG_IO_U16(REG_OFFSET_DMA3CNT_H)

#define REG_TMCNT(n)    REG_IO_U32(REG_OFFSET_TMCNT + ((n) * 4))
#define REG_TMCNT_L(n)  REG_IO_U16(REG_OFFSET_TMCNT_L + ((n) * 4))
#define REG_TMCNT_H(n)  REG_IO_U16(REG_OFFSET_TMCNT_H + ((n) * 4))
#define REG_TM0CNT      REG_IO_U32(REG_OFFSET_TM0CNT)
#define REG_TM0CNT_L    REG_IO_U16(REG_OFFSET_TM0CNT_L)
#define REG_TM0CNT_H    REG_IO_U16(REG_OFFSET_TM0CNT_H)
#define REG_TM1CNT      REG_IO_U32(REG_OFFSET_TM1CNT)
#define REG_TM1CNT_L    REG_IO_U16(REG_OFFSET_TM1CNT_L)
#define REG_TM1CNT_H    REG_IO_U16(REG_OFFSET_TM1CNT_H)
#define REG_TM2CNT      REG_IO_U32(REG_OFFSET_TM2CNT)
#define REG_TM2CNT_L    REG_IO_U16(REG_OFFSET_TM2CNT_L)
#define REG_TM2CNT_H    REG_IO_U16(REG_OFFSET_TM2CNT_H)
#define REG_TM3CNT      REG_IO_U32(REG_OFFSET_TM3CNT)
#define REG_TM3CNT_L    REG_IO_U16(REG_OFFSET_TM3CNT_L)
#define REG_TM3CNT_H    REG_IO_U16(REG_OFFSET_TM3CNT_H)

#define REG_SIOCNT      REG_IO_U16(REG_OFFSET_SIOCNT)
#define REG_SIODATA8    REG_IO_U16(REG_OFFSET_SIODATA8)
#define REG_SIODATA32   REG_IO_U32(REG_OFFSET_SIODATA32)
#define REG_SIOMLT_SEND REG_IO_U16(REG_OFFSET_SIOMLT_SEND)
#define REG_SIOMLT_RECV REG_IO_U64(REG_OFFSET_SIOMLT_RECV)
#define REG_SIOMULTI(n) REG_IO_U16(REG_OFFSET_SIOMULTI0 + (n) * 2)
#define REG_SIOMULTI0   REG_IO_U16(REG_OFFSET_SIOMULTI0)
#define REG_SIOMULTI1   REG_IO_U16(REG_OFFSET_SIOMULTI1)
#define REG_SIOMULTI2   REG_IO_U16(REG_OFFSET_SIOMULTI2)
#define REG_SIOMULTI3   REG_IO_U16(REG_OFFSET_SIOMULTI3)

#define REG_KEYINPUT    REG_IO_U16(REG_OFFSET_KEYINPUT)
#define REG_KEYCNT      REG_IO_U16(REG_OFFSET_KEYCNT)

#define REG_RCNT        REG_IO_U16(REG_OFFSET_RCNT)

#define REG_IME         REG_IO_U16(REG_OFFSET_IME)
#define REG_IE          REG_IO_U16(REG_OFFSET_IE)
#define REG_IF          REG_IO_U16(REG_OFFSET_IF)

#define REG_WAITCNT     REG_IO_U16(REG_OFFSET_WAITCNT)
